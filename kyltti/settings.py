...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/matias/Dropbox/kyltti/kyltti.com/kyltti/db.sq3',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '$55ubj*z)0_1t+w_!i_s==$weo3=f^j1hv2=9&amp;ymy8@ec#(pm!'
...
ROOT_URLCONF = 'kyltti.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'kyltti.wsgi.application'
